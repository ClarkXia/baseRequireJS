/**
 * mobile函数，功能包括 UA 判断、页面适配
 * 支持AMD加载，但该 JS 应在 head 中尽可能早的引入，减少重绘。
 *
 * fixScreen 方法根据两种情况适配，该方法自动执行。
 *      1. 定宽： 对应 meta 标签写法 -- <meta name="viewport" content="target-densitydpi=device-dpi,width=640">
 ...
 *          该方法约束：IOS 系统最大 dpr = 3，其它系统 dpr = 1，页面每 dpr 最大宽度（即页面宽度/dpr） = 640，REM 换算比值为 16。
...
function mobile(){
    var UA = navigator.userAgent,
        ...
        isMobile = isAndroid || isIos, //仅对安卓和ios做判断
